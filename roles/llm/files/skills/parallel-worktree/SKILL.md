...
4. Create worktree: add (`git worktree add ../<repo>-<suffix> -b <branch>`, pop stash there), copy all untracked dirs (skip on failure), open (`code --new-window ../<repo>-<suffix>`). On failure, notify and suggest a fix.
